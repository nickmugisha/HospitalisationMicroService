...
MYSQL_BI_DATABASE=os.getenv("MYSQL_BI_DATABASE","hospital_bi")
DATABASE_URL=URL.create(drivername="mysql+pymysql",username=MYSQL_USER,password=MYSQL_PASSWORD,host=MYSQL_HOST,port=MYSQL_PORT,database=MYSQL_BI_DATABASE,query={"charset":"utf8mb4"})
BI_GRPC_HOST=os.getenv("BI_GRPC_HOST","0.0.0.0")
BI_GRPC_PORT=int(os.getenv("BI_GRPC_PORT","50060"))
...
CHATBOT_GRPC_TARGET=os.getenv("CHATBOT_GRPC_TARGET","127.0.0.1:50061")
BI_MAX_PATIENT_SCAN=int(os.getenv("BI_MAX_PATIENT_SCAN","200"))
BI_MAX_MEDICINE_SCAN=int(os.getenv("BI_MAX_MEDICINE_SCAN","200"))
