...
MYSQL_CONSULTATION_DATABASE = os.getenv("MYSQL_CONSULTATION_DATABASE", "hospital_consultation")
...
DATABASE_URL = URL.create(
    ...
    host=MYSQL_HOST,
    port=MYSQL_PORT,
    database=MYSQL_CONSULTATION_DATABASE,
    query={"charset": "utf8mb4"},
)

CONSULTATION_GRPC_HOST = os.getenv("CONSULTATION_GRPC_HOST", "0.0.0.0")
CONSULTATION_GRPC_PORT = int(os.getenv("CONSULTATION_GRPC_PORT", "50055"))
