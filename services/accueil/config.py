...
MYSQL_ACCUEIL_DATABASE = os.getenv("MYSQL_ACCUEIL_DATABASE", "hospital_accueil")
...
DATABASE_URL = URL.create(
    ...
    host=MYSQL_HOST,
    port=MYSQL_PORT,
    database=MYSQL_ACCUEIL_DATABASE,
    query={"charset": "utf8mb4"},
)

ACCUEIL_GRPC_HOST = os.getenv("ACCUEIL_GRPC_HOST", "0.0.0.0")
ACCUEIL_GRPC_PORT = int(os.getenv("ACCUEIL_GRPC_PORT", "50052"))
