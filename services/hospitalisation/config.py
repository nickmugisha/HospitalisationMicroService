...
MYSQL_HOSPITALISATION_DATABASE = os.getenv("MYSQL_HOSPITALISATION_DATABASE", "hospital_hospitalisation")
...
DATABASE_URL = URL.create(
    ...
    host=MYSQL_HOST,
    port=MYSQL_PORT,
    database=MYSQL_HOSPITALISATION_DATABASE,
    query={"charset": "utf8mb4"},
)

HOSPITALISATION_GRPC_HOST = os.getenv("HOSPITALISATION_GRPC_HOST", "0.0.0.0")
HOSPITALISATION_GRPC_PORT = int(os.getenv("HOSPITALISATION_GRPC_PORT", "50053"))
