...
MYSQL_BILLING_DATABASE = os.getenv("MYSQL_BILLING_DATABASE", "hospital_billing")
...
DATABASE_URL = URL.create(
    ...
    host=MYSQL_HOST,
    port=MYSQL_PORT,
    database=MYSQL_BILLING_DATABASE,
    query={"charset": "utf8mb4"},
)

BILLING_GRPC_HOST = os.getenv("BILLING_GRPC_HOST", "0.0.0.0")
BILLING_GRPC_PORT = int(os.getenv("BILLING_GRPC_PORT", "50054"))
