...
New-Item -ItemType Directory -Force -Path "$ProjectRoot\generated\pharmacie\v1" | Out-Null
...
if ($LASTEXITCODE -ne 0) { throw "Pharmacie protobuf generation failed." }

New-Item -ItemType File -Force -Path "$ProjectRoot\generated\pharmacie\__init__.py" | Out-Null
New-Item -ItemType File -Force -Path "$ProjectRoot\generated\pharmacie\v1\__init__.py" | Out-Null
Write-Host "PROJECTX PHARMACIE PROTO GENERATED OK"
