...
New-Item -ItemType Directory -Force -Path "$ProjectRoot\generated\hospitalisation\v1" | Out-Null
...
if ($LASTEXITCODE -ne 0) { throw "Hospitalisation protobuf generation failed." }
New-Item -ItemType File -Force -Path "$ProjectRoot\generated\hospitalisation\__init__.py" | Out-Null
New-Item -ItemType File -Force -Path "$ProjectRoot\generated\hospitalisation\v1\__init__.py" | Out-Null
Write-Host "PROJECTX HOSPITALISATION PROTO GENERATED OK"
